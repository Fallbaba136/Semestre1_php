...
class JarvisLogger 
{
    ...
    echo   "<form action='$action' method='post'>
        <h3 class='text-dark ms-3 pb-5 text-center'>
        <div style='font-family: 'Unica One', cursive;'>
            PLEASE LOGIN
        </div>
        </h3>
        <input type='text' class='form-control' id='username' placeholder='USERNAME' name='username'>
         <input type='password' class='form-control' id='password' placeholder='PASSWORD' name='password', sans-serif;'>
